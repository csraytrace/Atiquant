...
plt.title(r"Massenstreukoeffizient bei Rh-K$_{\alpha}$ (20.2 keV)")
plt.savefig("C:\\Users\\julia\\OneDrive\\Dokumente\\A_Christian\\Masterarbeit\\Masterarbeit\\Massenstreukoeffizienten.png", dpi=500, bbox_inches='tight', transparent=True)
